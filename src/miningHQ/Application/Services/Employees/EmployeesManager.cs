...
public class EmployeesManager : IEmployeesService
{
    ...
    public EmployeesManager(IEmployeeRepository employeeRepository, EmployeeBusinessRules employeeBusinessRules)
    {
    ...
    {
        Employee? employee = await _employeeRepository.GetAsync(predicate, include, withDeleted, enableTracking, cancellationToken);
        return employee;
    }
