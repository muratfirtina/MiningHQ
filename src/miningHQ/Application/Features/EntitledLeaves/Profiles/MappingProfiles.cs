...
public class MappingProfiles : Profile
{
    public MappingProfiles()
    {
        ...
        CreateMap<List<EntitledLeave>, GetListResponse<GetListEntitledLeaveListItemDto>>().ReverseMap();
        CreateMap<List<EntitledLeave>, GetListResponse<GetEmployeeEntitledLeaveDto>>().ReverseMap();
