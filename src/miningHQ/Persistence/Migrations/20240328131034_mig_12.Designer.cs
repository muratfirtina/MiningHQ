...
namespace Persistence.Migrations
{
    ...
    [Migration("20240328131034_mig_12")]
            ...
            modelBuilder.Entity("Core.Security.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = new byte[] { 20, 95, 205, 115, 202, 108, 72, 86, 105, 81, 152, 252, 4, 128, 73, 123, 55, 51, 15, 12, 143, 33, 198, 0, 185, 221, 17, 221, 28, 77, 91, 254, 116, 0, 16, 250, 253, 191, 157, 88, 148, 126, 49, 203, 104, 151, 208, 180, 210, 235, 114, 161, 15, 215, 195, 124, 47, 45, 155, 167, 113, 206, 170, 244 },
                            PasswordSalt = new byte[] { 50, 220, 123, 127, 58, 154, 100, 199, 36, 160, 248, 203, 237, 211, 82, 59, 187, 87, 174, 80, 20, 65, 30, 254, 1, 134, 103, 25, 44, 5, 78, 74, 104, 70, 117, 135, 77, 209, 97, 33, 185, 208, 240, 204, 70, 18, 89, 206, 79, 36, 26, 122, 26, 141, 96, 17, 16, 105, 81, 78, 151, 142, 136, 177, 221, 114, 81, 173, 181, 181, 105, 174, 191, 14, 239, 83, 57, 117, 113, 35, 220, 38, 108, 41, 36, 240, 231, 108, 109, 235, 180, 18, 93, 218, 211, 45, 240, 149, 235, 253, 223, 123, 200, 87, 93, 250, 244, 163, 191, 181, 90, 59, 26, 139, 126, 22, 211, 134, 39, 117, 18, 225, 165, 221, 228, 222, 61, 120 },
                            Status = true
                        });
                });
