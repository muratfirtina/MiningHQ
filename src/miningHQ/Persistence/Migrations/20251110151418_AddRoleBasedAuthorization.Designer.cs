...
namespace Persistence.Migrations
{
    ...
    [Migration("20251110151418_AddRoleBasedAuthorization")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Security.Entities.OperationClaim", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 110,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "QuarryModerators.Admin"
                        },
                        new
                        {
                            Id = 111,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "QuarryModerators.Read"
                        },
                        new
                        {
                            Id = 112,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "QuarryModerators.Write"
                        },
                        new
                        {
                            Id = 113,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "QuarryModerators.Add"
                        },
                        new
                        {
                            Id = 114,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "QuarryModerators.Update"
                        },
                        new
                        {
                            Id = 115,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "QuarryModerators.Delete"
                        });
                });
            ...
            modelBuilder.Entity("Core.Security.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2025, 11, 10, 15, 14, 18, 441, DateTimeKind.Utc).AddTicks(7790),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2025, 11, 10, 15, 14, 18, 441, DateTimeKind.Utc).AddTicks(7790),
                            Description = "Quarry moderator with limited access",
                            Name = "Moderator"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2025, 11, 10, 15, 14, 18, 441, DateTimeKind.Utc).AddTicks(7790),
                            Description = "HR assistant with employee management access",
                            Name = "HRAssistant"
                        });
                });

            modelBuilder.Entity("Core.Security.Entities.RoleOperationClaim", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 11, 10, 15, 14, 18, 441, DateTimeKind.Utc).AddTicks(9850),
                            OperationClaimId = 1,
                            RoleId = 1
                        });
                });
            ...
            modelBuilder.Entity("Core.Security.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = new byte[] { 19, 242, 104, 254, 229, 139, 13, 179, 167, 81, 63, 22, 19, 90, 112, 219, 16, 204, 208, 165, 203, 19, 4, 64, 91, 153, 87, 101, 46, 209, 150, 83, 93, 62, 53, 86, 115, 175, 135, 245, 232, 35, 235, 240, 166, 217, 139, 217, 64, 35, 33, 112, 171, 66, 166, 195, 182, 225, 111, 52, 89, 202, 129, 155 },
                            PasswordSalt = new byte[] { 76, 227, 192, 159, 20, 100, 149, 77, 252, 224, 173, 208, 19, 126, 75, 50, 78, 158, 190, 85, 69, 72, 209, 19, 138, 68, 202, 29, 197, 150, 231, 187, 14, 197, 18, 236, 117, 74, 255, 23, 145, 21, 60, 209, 212, 100, 34, 115, 187, 4, 92, 122, 248, 119, 89, 238, 207, 86, 110, 31, 143, 87, 201, 6, 119, 12, 115, 200, 38, 186, 230, 231, 84, 247, 121, 244, 109, 162, 1, 107, 2, 139, 79, 93, 110, 240, 250, 158, 17, 132, 206, 8, 132, 142, 67, 75, 240, 86, 55, 222, 59, 242, 20, 150, 55, 82, 137, 171, 51, 130, 187, 115, 61, 59, 140, 142, 57, 193, 59, 139, 113, 40, 66, 3, 215, 132, 59, 241 },
                            Status = true
                        });
                });
            ...
            modelBuilder.Entity("Core.Security.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 11, 10, 15, 14, 18, 442, DateTimeKind.Utc).AddTicks(7680),
                            RoleId = 1,
                            UserId = new Guid("729c40f5-0859-48d7-a388-451520c1289c")
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.QuarryModerator", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("QuarryModerators", (string)null);
                });
