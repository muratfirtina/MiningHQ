...
namespace Persistence.Migrations
{
    ...
    [Migration("20240329092138_mig_1")]
    partial class mig_1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Security.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = new byte[] { 86, 214, 127, 82, 200, 93, 53, 129, 147, 100, 41, 49, 45, 109, 197, 67, 241, 210, 156, 151, 76, 76, 159, 179, 238, 106, 246, 104, 150, 23, 61, 23, 137, 116, 18, 88, 147, 248, 66, 1, 49, 98, 121, 163, 208, 128, 83, 171, 8, 249, 254, 8, 175, 1, 220, 79, 25, 39, 95, 155, 254, 237, 213, 136 },
                            PasswordSalt = new byte[] { 206, 22, 4, 140, 74, 12, 237, 115, 1, 60, 165, 140, 49, 183, 255, 213, 224, 57, 8, 66, 84, 123, 118, 149, 10, 198, 102, 146, 23, 72, 102, 184, 85, 53, 237, 81, 141, 168, 190, 207, 65, 105, 220, 82, 180, 246, 201, 21, 203, 29, 29, 178, 155, 90, 154, 21, 74, 99, 249, 231, 0, 140, 165, 135, 69, 61, 174, 153, 32, 170, 164, 138, 195, 42, 89, 178, 199, 14, 48, 224, 171, 250, 107, 150, 160, 135, 205, 176, 172, 41, 175, 36, 154, 241, 24, 174, 125, 203, 125, 105, 123, 247, 201, 130, 151, 10, 157, 94, 125, 198, 244, 178, 24, 200, 54, 167, 233, 17, 69, 247, 250, 204, 49, 28, 199, 138, 98, 39 },
                            Status = true
                        });
                });
