...
namespace Persistence.Migrations
{
    ...
    [Migration("20231101150411_mig_1")]
    partial class mig_1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Security.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = new byte[] { 158, 93, 61, 198, 178, 164, 132, 64, 114, 204, 227, 82, 233, 244, 180, 122, 81, 158, 63, 121, 206, 93, 35, 126, 124, 111, 178, 164, 243, 26, 120, 35, 96, 72, 126, 48, 55, 165, 39, 171, 106, 232, 68, 3, 237, 18, 152, 209, 162, 97, 56, 96, 24, 62, 244, 183, 47, 5, 104, 36, 57, 135, 88, 205 },
                            PasswordSalt = new byte[] { 64, 55, 125, 232, 76, 251, 156, 194, 138, 236, 77, 208, 61, 197, 160, 12, 91, 96, 183, 40, 170, 150, 69, 129, 98, 122, 20, 54, 236, 64, 102, 225, 219, 253, 20, 173, 83, 159, 218, 165, 143, 199, 175, 96, 60, 1, 25, 140, 47, 61, 32, 11, 242, 204, 7, 77, 151, 190, 143, 81, 166, 246, 63, 102, 178, 135, 76, 64, 24, 85, 67, 147, 75, 15, 206, 68, 60, 162, 12, 214, 73, 217, 170, 28, 113, 136, 161, 18, 118, 243, 132, 63, 14, 23, 118, 47, 56, 69, 63, 107, 84, 29, 116, 231, 246, 79, 104, 193, 238, 144, 139, 214, 215, 67, 158, 12, 48, 231, 62, 208, 25, 46, 238, 132, 50, 70, 85, 147 },
                            Status = true
                        });
                });
