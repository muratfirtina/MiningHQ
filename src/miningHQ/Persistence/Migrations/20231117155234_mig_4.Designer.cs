...
namespace Persistence.Migrations
{
    ...
    [Migration("20231117155234_mig_4")]
    partial class mig_4
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Security.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = new byte[] { 210, 134, 214, 200, 108, 11, 197, 181, 201, 203, 138, 57, 100, 54, 124, 174, 221, 46, 211, 208, 89, 88, 140, 189, 60, 235, 135, 11, 255, 52, 248, 220, 143, 61, 96, 239, 44, 200, 61, 42, 226, 219, 1, 26, 9, 187, 91, 176, 90, 251, 154, 118, 25, 101, 98, 165, 45, 255, 14, 176, 147, 61, 221, 97 },
                            PasswordSalt = new byte[] { 229, 110, 159, 3, 129, 116, 35, 83, 5, 60, 193, 99, 96, 249, 163, 245, 251, 64, 203, 229, 189, 70, 150, 81, 38, 200, 8, 216, 155, 157, 57, 92, 140, 25, 205, 10, 26, 179, 13, 247, 135, 125, 62, 212, 118, 104, 171, 162, 20, 146, 41, 61, 93, 170, 3, 88, 101, 95, 178, 204, 184, 95, 76, 102, 173, 93, 66, 146, 123, 162, 173, 172, 167, 173, 171, 222, 253, 113, 52, 194, 222, 185, 42, 114, 242, 31, 144, 163, 207, 193, 207, 188, 241, 160, 254, 99, 246, 85, 144, 48, 231, 92, 112, 31, 80, 198, 73, 19, 218, 68, 175, 77, 149, 90, 64, 58, 57, 231, 34, 203, 168, 3, 22, 29, 93, 94, 56, 8 },
                            Status = true
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.EmployeeLeaveUsage", b =>
                {
                    ...
                    b.Property<int>("TotalEntitledLeaves")
                        .HasColumnType("integer")
                        .HasColumnName("TotalEntitledLeaves");

                    b.Property<int>("TotalUsedLeaveDays")
                        .HasColumnType("integer")
                        .HasColumnName("TotalUsedLeaveDays");
